"""
2026-02-16 Maria Yli-Heikkilä

To set up boto3-connection to Allas, you need to create a S3 access token or use the existing token 
for the project. Do Cloud storage configuration @Puhti web interface (Tools)
...
RUN:
python 03-boto3-Allas-upload.py -i /scratch/project_2008047/Apu-HIKET/results -b Apu-HIKET
